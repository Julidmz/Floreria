        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="insertarFlor.jsp">Agregar Flor</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container my-4">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <%
                        // Instanciar el DAO y obtener la lista de flores
                    ...
                    <tr>
                        <td><%= flor.getId() %></td>
                        <td><%= flor.getNombre() %></td>
                        <td><%= flor.getCantidad() %></td>
                        <td><%= flor.getPrecioCosto() %></td>
                        <td><%= flor.getPrecioVenta() %></td>
                        <td>
                            <a href="editarFlor?id=<%= flor.getId() %>" class="btn btn-primary btn-sm">Editar</a>
                            <a href="eliminarFlor?id=<%= flor.getId() %>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar esta flor?');">Eliminar</a>
                        </td>
                    </tr>
                    <%
                        }
